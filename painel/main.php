...
<div class="menu">
	...
	<div class="items-menu">
		...
		<a <?php selecionadoMenu('gerenciar-produtos'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-produtos">Gerenciar Produtos</a>
		<a <?php selecionadoMenu('gerenciar-categorias'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-categorias">Gerenciar Categorias</a>

		<h2>Configuração Geral do Site</h2>
		<a <?php selecionadoMenu('editar-site'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>editar-site">Editar Informações do Site</a>
		<a <?php selecionadoMenu('gerenciar-carrousel'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-carrousel">Gerenciar Slides</a>
		<a <?php selecionadoMenu('editar-descricao'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>editar-descricao">Editar Descrição no Site</a>
		<a <?php selecionadoMenu('gerenciar-specials'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-specials">Gerenciar Produtos em Destaque</a>
		<a <?php selecionadoMenu('gerenciar-colaboradores'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-colaboradores">Gerenciar Colaboradores</a>
		<a <?php selecionadoMenu('gerenciar-galeria'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-galeria">Gerenciar Galeria de Fotos</a>
		<a <?php selecionadoMenu('gerenciar-feedback'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-feedback">Gerenciar Feedbacks</a>
